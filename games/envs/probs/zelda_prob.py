...
from games.envs.helper import get_range_reward, get_tile_locations, calc_num_regions, calc_certain_tile, run_dikjstra
...
class ZeldaProblem(Problem):
    ...
    def get_tile_types(self):
        return ["empty", "solid", "player", "key", "door", "bat", "scorpion", "spider", "path"]
    ...
    def render(self, map):
        if self._graphics == None:
            self._graphics = {
                ...
                "path": Image.open(os.path.dirname(__file__) + "/zelda/path.png").convert('RGBA'),
            }
